...
/**
 * Abstract implementation of the {@link PayloadCarryingEndpointProber}.
 *
 * @author Mikhail Polivakha
 */
public abstract class AbstractPayloadCarryingEndpointProber<I, O> implements PayloadCarryingEndpointProber<I, O> {
    ...
    public AbstractPayloadCarryingEndpointProber(
    ...
    @Override
    public @NonNull O invoke(@NonNull I body, InstanceId instanceId)
                    ...
                    HttpRequest.newBuilder()
                            .method(
                                    ...
                                    HttpRequest.BodyPublishers.ofByteArray(
                                            messageSerializationStrategy.serialize(body)))
