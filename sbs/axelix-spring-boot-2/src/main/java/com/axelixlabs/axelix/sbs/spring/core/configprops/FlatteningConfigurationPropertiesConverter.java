...
public class FlatteningConfigurationPropertiesConverter implements ConfigurationPropertiesConverter {
    ...
    @Override
    public ConfigPropsFeed convert(ApplicationConfigurationProperties originalDescriptor) {
    ...
    private ConfigPropsFeed.Context convertContext(ContextConfigurationProperties source) {
