...
class ScheduledTaskManagementEndpointTest {
    ...
    private static final String CRON_TASK_ID =
            ScheduledTaskManagementEndpointTestConfiguration.class.getName() + ".testCronTask";
    private static final String CRON_TASK_ID_FOR_MODIFY =
            ScheduledTaskManagementEndpointTestConfiguration.class.getName() + ".testCronTaskForModify";

    // FixedDelay
    private static final String FIXED_DELAY_TASK_ID =
            ScheduledTaskManagementEndpointTestConfiguration.class.getName() + ".testFixedDelayTask";
    private static final String FIXED_DELAY_TASK_ID_FOR_MODIFY =
            ScheduledTaskManagementEndpointTestConfiguration.class.getName() + ".testFixedDelayTaskForModify";
    private static final String FIXED_DELAY_TASK_ID_FOR_EXECUTE =
            ScheduledTaskManagementEndpointTestConfiguration.class.getName() + ".testFixedDelayTaskForExecute";

    // FixedRate
    private static final String FIXED_RATE_TASK_ID =
            ScheduledTaskManagementEndpointTestConfiguration.class.getName() + ".testFixedRateTask";
    private static final String FIXED_RATE_TASK_ID_FOR_MODIFY =
            ScheduledTaskManagementEndpointTestConfiguration.class.getName() + ".testFixedRateTaskForModify";
    private static final String FIXED_RATE_TASK_ID_FOR_EXECUTE =
            ScheduledTaskManagementEndpointTestConfiguration.class.getName() + ".testFixedRateTaskForExecute";

    // Custom
    private static final String CUSTOM_TASK_ID =
            ScheduledTaskManagementEndpointTestConfiguration.CustomTestTask.class.getName();
    ...
    static class ScheduledTaskManagementEndpointTestConfiguration implements SchedulingConfigurer {
        ...
        @Bean
        public TaskRescheduler testTriggerBasedTaskRescheduler(TaskScheduler taskScheduler) {
            return new TriggerBasedTaskRescheduler(taskScheduler);
        }

        @Bean
        public TaskRescheduler testIntervalBasedTaskRescheduler(TaskScheduler taskScheduler) {
